...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 0;//1.3;               //Gain setting for the roll P-controller
...
void loop(){
  ...
  while(c < 15){                                                       //Stay in this loop until output 4,5,6 and 7 are low.
    ...
    if(timer_channel_2 <= esc_loop_timer){
       PORTD &= B11111011;                //Set digital output 5 to low if the time is expired.
       c |= B00000010;
    }
    if(timer_channel_3 <= esc_loop_timer){
       PORTD &= B11110111;                //Set digital output 6 to low if the time is expired.
       c |= B00000100;
    }
